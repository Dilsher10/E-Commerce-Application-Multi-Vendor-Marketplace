              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                ...
                <div className="lg:col-span-1">
                  ...
                  <div className="flex gap-2">
                    <input type="email" placeholder="Email address" className="bg-[var(--bg-color)] text-sm py-2.5 px-4 rounded-lg flex-1" />
                    <button className="btn btn-primary px-5 py-2.5 text-sm rounded-lg">Subscribe</button>
                  </div>
                </div>
